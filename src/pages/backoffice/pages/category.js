...
export const Categories = () => {
  ...
  const createCategory = async () => {
    ...
    const response = await requester(
      'http://localhost/php-back/Category/Create',
      'POST',
      params
    )
    ...
    if (response.errors) {
      ...
      changeModal({
        message: 'Your category has been submited!',
        time: 3000,
        type: 'success',
      })
      setEditing(false)
      ...
      <ThemeProvider theme={theme}>
        {!editing ? (
          ...
          <div className="editing-line">
            ...
            <span className="submitBtn" onClick={createCategory}>
              <Button variant="contained" color="primary">
                Submit
              </Button>
            </span>
            <span
              ...
              onClick={() => {
                changeModal({
                  message: 'Category creation aborted',
                  time: 2000,
                  type: 'failed',
                })
                setEditing(false)
